...
import com.chiancloud.docdive.utils.DateUtils;
import com.chiancloud.docdive.utils.ESUtil;

public class CC {

	public static void main(String[] args) throws Exception {
		ESUtil esUtil = new ESUtil("elasticsearch", "172.16.50.81", 19300);
		...
		list.add(map);
		int result = new ESUtil("elasticsearch", "172.16.50.81", 19300)
